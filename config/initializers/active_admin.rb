ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Streetstitch"
  ...
  config.namespace :admin do |admin|
    admin.build_menu do |menu|
      menu.add label: "Store", priority: 1 do |store|
        store.add label: "Products", url: "/admin/products"
        store.add label: "Categories", url: "/admin/categories"
      end
      menu.add label: "Site Pages", url: "/admin/pages", priority: 2
    end
  end
